...
const TILE := 32
const TILE_DEFS := {
	"#": {"color": "16301a", "solid": true},
	".": {"color": "1d2a19", "solid": false},
	",": {"color": "3a2f1f", "solid": false},
	"~": {"color": "10283d", "solid": true},
	"^": {"color": "2b241c", "solid": true},
	"=": {"color": "241c14", "solid": false},
	"W": {"color": "26201a", "solid": true},
}
