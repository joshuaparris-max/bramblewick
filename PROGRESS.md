...
- [x] **Living Town Expansion**
  - Command: cmd /c "C:\dev\Godot_v4.7-stable_win64.exe\Godot_v4.7-stable_win64_console.exe --headless tests/test_runner.tscn" and manual PCK export.
  - Exit code: 0
  ...
  - Not proven: Real gameplay behavior (requires user to playtest).
